...
public class Problem0011 {
    ...
    private static final String INPUT_FILENAME = "Problem0011.input";
    ...
    private static int[][] parseInput() throws IOException, URISyntaxException {
        final int[][] input = new int[GRID_SIZE][GRID_SIZE];
        final int[] currentLine = {0};
        final BufferedReader reader = Utilities.getResourceBufferedReader(INPUT_FILENAME);
